...
class AgendamentosExamesConfigModel extends Model
{

	protected $table = 'age_agendamentosexamesconfig';
	...
	public function pegaTudo()
	{
		...
		from age_agendamentosexamesconfig ac
		...
		join age_agendamentosexamesstatusconfig ass on ass.codStatus=ac.codStatusExame
		join age_agendamentosexamestipo t on t.codTipo=ac.codTipoExame
	...
	{
		if ($this->db->query('delete from age_agendamentosexames where codConfig = ' . $codConfig . ' and codPaciente=0')) {
			return true;
		}
	}
	...
	public function updateAgendamentosExames($codConfig, $data)
	{
		if ($codConfig !== NULL and $codConfig !== "" and $codConfig !== " ") {

			$this->db->where('codConfig', $codConfig);
			$this->db->update('age_agendamentosexames', $data);
		}
	}
	...
	public function vagasCriadas($codConfig)
	{
		...
		join age_agendamentosexamesconfig ac on ac.codConfig=a.codConfig
