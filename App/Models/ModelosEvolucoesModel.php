...
class ModelosEvolucoesModel extends Model
{

	protected $table = 'amb_modelosevolucoes';
	...
	public function pegaTudo()
	{
		...
		$query = $this->db->query('select * from amb_modelosevolucoes');
