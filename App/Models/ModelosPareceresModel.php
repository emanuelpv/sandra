...
class ModelosPareceresModel extends Model
{

	protected $table = 'amb_modelospareceres';
	...
	public function pegaTudo()
	{
		...
		$query = $this->db->query('select * from amb_modelospareceres');
