				...
				<div class="card-header">
					<div class="row">
						<div class="col-md-8 mt-2">
							<h3 style="font-size:30px;font-weight: bold;" class="card-title">Cargos</h3>
						</div>
						<div class="col-md-4">
			...
			<div class="modal-body">
				<form id="add-form" class="pl-3 pr-3">
					<div class="row">
						...
						<input type="hidden" id="codCargo" name="codCargo" class="form-control" placeholder="Codigo" maxlength="11" required>
					</div>
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label for="descricaoCargo"> Descrição cargo: <span class="text-danger">*</span> </label>
								<input type="text" id="descricaoCargo" name="descricaoCargo" class="form-control" placeholder="Descrição cargo" maxlength="100" required>
							</div>
						</div>

						<div class="col-md-4">
							<div class="form-group">
								<label for="siglaCargo"> Sigla: <span class="text-danger">*</span> </label>
								<input type="text" id="siglaCargo" name="siglaCargo" class="form-control" placeholder="Sigla da Cargo" maxlength="60" required>
							</div>
						</div>
					</div>
	...
	function edit(codCargo) {
		$.ajax({
			...
			success: function(response) {
				...
				$("#edit-form #codCargo").val(response.codCargo);
				$("#edit-form #descricaoCargo").val(response.descricaoCargo);
				$("#edit-form #siglaCargo").val(response.siglaCargo);
