...
<body class="hold-transition sidebar-mini layout-fixed">
								...
								?>
									<div class="col-md-4">
										...
										<div class="callout callout-info">
											...
											<div class="row">
												<div  class="col-md-3">
													<img class="borda" style="width:80px" alt="" src="<?php echo $fotoPerfil ?>">
												</div>
												<div class="col-md-9">

													<h4><?php echo $medico->nomeExibicao; ?></h4>
													<p><?php echo $medico->descricaoEspecialidade; ?></p>
												</div>
											</div>
	...
	<footer class="main-footer">
		...
		<strong>DESENVOLVIDO PELO CAP QCO INFORMÁTICA EMANUEL | Chefe do Setor de Tecnologia da Informação do hospital <a href="https://www.linkedin.com/in/emanuelpv"> - Linkedin</a></strong>
		<div>
