				...
				<div class="card-header">
					<div class="row">
						<div class="col-md-8 mt-2">
							<h3 style="font-size:30px;font-weight: bold;" class="card-title">Status Projetos</h3>
						</div>
						<div class="col-md-4">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label for="descricaoStatusProjeto"> Descrição: <span class="text-danger">*</span> </label>
								<input type="text" id="descricaoStatusProjeto" name="descricaoStatusProjeto" class="form-control" placeholder="Descrição" maxlength="50" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="codCorStatusProjeto"> Cor: <span class="text-danger">*</span> </label>
								<input type="text" id="codCorStatusProjeto" name="codCorStatusProjeto" class="form-control" placeholder="Cor" maxlength="10" required>
							</div>
						</div>
					</div>
