					...
					<div class="card card-primary">
						<div class="card-header p-0 border-bottom-0">
							<ul class="nav nav-tabs" id="Perfis" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="perfil-tab" data-toggle="pill" href="#perfil" role="tab" aria-controls="perfil" aria-selected="true">Perfil</a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item">
									<a class="nav-link" id="pessoas-tab" data-toggle="pill" href="#pessoas" role="tab" aria-controls="pessoas" aria-selected="false">Membros</a>
								</li>
								<li class="nav-item">
