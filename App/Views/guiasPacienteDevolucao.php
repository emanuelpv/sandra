...
if (session()->codPlano !== NULL) {
	$codPlano = session()->codPlano;
} else {
	$codPlano = NULL;
}
		...
		<div class="card">
			<div class="card-body register-card-body">
				...
				<form id="guiasPacienteDevolucaoForm" class="pl-3 pr-3">
					...
					<div class="input-group mb-3">
						<input type="number" autocomplete="off" class="form-control" id="codPlano" name="codPlano" placeholder="Nº Nº Plano" value="<?php echo $codPlano ?>" required>
						<div class="input-group-append">
							<div class="input-group-text">
					...
					<div class="input-group mb-3">
						<input type="text" autocomplete="off" class="form-control" id="nomeBeneficiario" name="nomeBeneficiario" placeholder="Nome do beneficiário" value="<?php echo session()->nomeCompleto ?>" required>
						<div class="input-group-append">
							<div class="input-group-text">
								<span class="fas fa-user"></span>
							</div>
