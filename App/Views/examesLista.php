				...
				<div class="card-header">
					<div class="row">
						<div class="col-md-8 mt-2">
							<h3 style="font-size:30px;font-weight: bold;" class="card-title">ExamesLista</h3>
						</div>
						<div class="col-md-4">
...
<script>
	...
	function add() {
		...
		$.ajax({
			url: '<?php echo base_url('examesLista/listaDropDownConselhos') ?>',
			type: 'post',
			dataType: 'json',
			data: {
				csrf_sandra: $("#csrf_sandraPrincipal").val(),
	...
	function editarMembroAgora() {
		...
		$(".text-danger").remove();
		$.ajax({
			url: '<?php echo base_url('examesLista/editMembro') ?>',
			type: 'post',
			data: form.serialize(),
			dataType: 'json',
	...
	function adicionarMembroAgora() {
		...
		$(".text-danger").remove();
		$.ajax({
			url: '<?php echo base_url('examesLista/addMembro') ?>',
			type: 'post',
			data: form.serialize(),
			dataType: 'json',
	...
	function AddMembroModal(codExameLista) {
		...
		$.ajax({
			url: '<?php echo base_url('examesLista/listaDropDownPessoas') ?>',
			type: 'post',
			dataType: 'json',
			data: {
				csrf_sandra: $("#csrf_sandraPrincipal").val(),
		...
		$.ajax({
			url: '<?php echo base_url('examesLista/listaDropDownEstadosFederacao') ?>',
			type: 'post',
			dataType: 'json',
			data: {
				csrf_sandra: $("#csrf_sandraPrincipal").val(),
		...
		$.ajax({
			...
			success: function(response) {
				...
				$('#data_tableMembros').DataTable({
					...
					"responsive": true,
					"ajax": {
						"url": '<?php echo base_url('examesLista/pegaMembros') ?>',
						"type": "POST",
						"dataType": "json",
						async: "true",
						data: {
	...
	function editexamesListaMembro(codExameListaMembro) {


		$.ajax({
			url: '<?php echo base_url('examesLista/pegaMembro') ?>',
			type: 'post',
			data: {
	...
	function removeexamesListaMembro(codExameListaMembro) {
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					url: '<?php echo base_url('examesLista/removeMembro') ?>',
					type: 'post',
					data: {
						codExameListaMembro: codExameListaMembro,
						csrf_sandra: $("#csrf_sandraPrincipal").val(),
