...
class Termos extends BaseController
{
	...
	public function index()
	{
		...
		$permissao = verificaPermissao('Termos', 'listar');
		if ($permissao == 0) {
			echo mensagemAcessoNegado(session()->organizacoes);
			$this->LogsModel->inserirLog('Acesso indevido ao Módulo Termos', session()->codPessoa);
			exit();
		}
	...
	public function edit()
	{
		...
		$this->validation->setRules([
			'codTermo' => ['label' => 'codTermo', 'rules' => 'required|numeric|max_length[11]'],
			'codPessoa' => ['label' => 'Autor', 'rules' => 'required|numeric|max_length[11]'],
			'assunto' => ['label' => 'Assunto', 'rules' => 'required|max_length[100]'],
			'termo' => ['label' => 'Termo', 'rules' => 'required'],
			'codStatus' => ['label' => 'Status', 'rules' => 'required|max_length[11]'],
