...
class FormatRules
{
     ...
     * naoReservado
     */
    public function bloquearReservado(?string $str = null): bool
    {
        $arrayPalavrasReservadas = array(
		'<script>',
		'<?php',
		'<?=',
		'<?',
		...
		foreach ($arrayPalavrasReservadas as $palavra) {
			if (strpos($str, $palavra) !== false) {
				return false;
			}
		}
		return true;
