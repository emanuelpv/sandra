        ...
        if (! $this->connID) {
            ...
            if (! $this->connID) {
				...
				echo '<script type="text/javascript">',
					...
					'html: "<div>Desculpe-nos o transtorno. Identificamos um problema de conexão com o banco de dados.</div> <div>Tente mais tarde!</div>",',
					...
					'})',
					 ...
					 echo '<div class="row">
								<div class="col-12">
									<center><img style="width:40%" src="'.base_url().'/imagens/emManutencao.jpg"></center>
